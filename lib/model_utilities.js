 ...
 * @return { boolean } [ true / false if parameter is a array ]
...
module.exports.cloneObject = (value) => {
	return _.isPlainObject(value) || _.isArray(value) ? _.cloneDeep(value) : value;
};
 ...
 module.exports.validateMoment = (value, formats) => {
	 return formats.some((format) => {
		 return moment(value, format).isValid() ||
			 (( value && value.toISOString ) ? moment(value.toISOString()).isValid() : false);
	 });
 };
